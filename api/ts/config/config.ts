...
const production = {
	...
	mysql: {
		...
		username: 'root',
		password: process.env.MYSQL_ROOT_PASSWORD || 'mysql@admin#wanhe',
		options: {
			dialect: 'mysql',
			host: process.env.MYSQL_IPV4 || '172.113.0.2',
			port: 3306,
			timezone: '+8:00',
			pool: {
				max: 5,
	...
	redis: {
		host: process.env.REDIS_IPV4 || '172.113.0.3',
		port: 6379
	},
	imageHost: 'https://cjzw.topjinrong.net.cn'
}
...
export const config = {
	...
	weapp_auth: {
		...
		appid: 'wx92f5d766eaf9b953',
		secret: '63b594b8035aac7c64fd588feb2800e1',
